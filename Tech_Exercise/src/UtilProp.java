...
public class UtilProp {
   ...
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/baileylicht/git/Tech_Exercise/Tech_Exercise/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/Tech_Exercise/config.properties";
